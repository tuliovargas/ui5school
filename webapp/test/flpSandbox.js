					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Students List",
									"targetURL": "#StudentsList-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"StudentsList-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=school.com.school",
									"url": sap.ui.require.toUrl("school/com/school")
								}
							}
						}
					}
